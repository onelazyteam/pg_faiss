...
DROP FUNCTION IF EXISTS pg_faiss_version();
DROP FUNCTION IF EXISTS pg_faiss_init();
DROP FUNCTION IF EXISTS pg_faiss_create_index(text, integer, text, text);
DROP FUNCTION IF EXISTS pg_faiss_drop_index(text);
DROP FUNCTION IF EXISTS pg_faiss_list_indexes();
DROP FUNCTION IF EXISTS pg_faiss_index_stats(text);
DROP FUNCTION IF EXISTS pg_faiss_get_index_info(text);
DROP FUNCTION IF EXISTS pg_faiss_add_vectors(text, real[], bigint[], integer);
DROP FUNCTION IF EXISTS pg_faiss_add_vector_array(text, real[], bigint);
DROP FUNCTION IF EXISTS pg_faiss_search(text, real[], integer);
DROP FUNCTION IF EXISTS pg_faiss_search_with_ids(text, real[], integer);
DROP FUNCTION IF EXISTS pg_faiss_search_both(text, real[], integer);
DROP FUNCTION IF EXISTS pg_faiss_search_array(text, real[], integer);
DROP FUNCTION IF EXISTS pg_faiss_train(text, real[]);
DROP FUNCTION IF EXISTS pg_faiss_save_index(text, text);
DROP FUNCTION IF EXISTS pg_faiss_load_index(text, text);
DROP FUNCTION IF EXISTS pg_faiss_set_data_directory(text);
DROP FUNCTION IF EXISTS pg_faiss_reset();
